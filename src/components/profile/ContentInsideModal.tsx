...
export default () => {
  ...
  async function fetchProfile() {
    if (session.data != undefined) {
      const profileFetch = await getProfile.mutateAsync({
  ...
  return (
    <>
      ...
      ></TextInput>
      <TextInput onChange={inputTagName} value={profile.tagName}></TextInput>
      <TextInput
      ...
      ></TextInput>
      <TextInput onChange={inputImage} value={profile.image}></TextInput>
      <div>
        {modified ? (
          <>
